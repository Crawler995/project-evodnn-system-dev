...
if __name__ == '__main__':
    # model = ResNet34_cifar(100)
    # # from models.resnet_cifar import resnet18_cifar100
    # # model = resnet18_cifar100()
    # # print(model)
    
    # from methods.ours_v1.model import convert_raw_model_to_big_model, convert_big_model_to_small_model
    # from utils.dl.common.model import get_all_specific_type_layers_name
    
    # # cond = lambda i: 'layer2' in i # < 1e-8
    # # cond = lambda i: 'layer1' in i # < 1e-10
    # cond = lambda i: 'shortcut' not in i
    
    # rep_layers = [i for i in get_all_specific_type_layers_name(model, (nn.Conv2d, )) 
    #               if cond(i)]
    
    # model = convert_raw_model_to_big_model(
    #     model, rep_layers, rep_layers, False, 0.5, True, (1, 3, 32, 32))
    # small_model = convert_big_model_to_small_model(model, True, (1, 3, 32, 32))
